      ...
      <div class="form-container">
        <form method="post">
          <div class="word-textarea">
            ...
            <textarea class="textarea" type="text" name="word" id="word" value="<?php echo $louchebem->getRequest()->getValueByFieldname('word') ?>"></textarea>
